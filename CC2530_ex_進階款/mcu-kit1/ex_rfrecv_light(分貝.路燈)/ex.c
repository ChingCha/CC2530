...
void main(void)
{
    ...
    halMcuWaitMs(1000);
    halLcdClear();
    halLcdWriteLine(HAL_LCD_LINE_1, "Road Light/Noise");
    halLcdWriteLine(HAL_LCD_LINE_2, "Lt =    db =    ");
    ...
    while (TRUE)
    {
        ...
        {  
          ...
          noise = pRxData[1];
             ...
             M160_On(100-val);
             halLcdDisplayUint8(HAL_LCD_LINE_2, 5, HAL_LCD_RADIX_DEC, val);
             halLcdDisplayUint8(HAL_LCD_LINE_2, 12, HAL_LCD_RADIX_DEC, noise);
         //halMcuWaitMs(50);
